...
def get_admin_main_kb(is_superadmin: bool = False, days_left: int = 30, ledger_type: str = 'receivable') -> ReplyKeyboardMarkup:
    if ledger_type == 'payable':
        ...
        buttons = [
            tabs_row,
            [KeyboardButton(text="📋 Haqdorlar (Qarz beruvchilar)")],
            [KeyboardButton(text="➕ Yangi qarz olish"), KeyboardButton(text="🔍 Qidirish")],
            [KeyboardButton(text="📊 Statistika"), KeyboardButton(text="📥 Excel hisoboti")],
            [KeyboardButton(text="⚙️ Daftar nomi"), KeyboardButton(text="🛡 Xavfsizlik va Tiklash")],
        ...
        buttons = [
            tabs_row,
            [KeyboardButton(text="📋 Qarzdorlar ro'yxati")],
            [KeyboardButton(text="➕ Yangi qo'shish"), KeyboardButton(text="🔍 Qidirish")],
            [KeyboardButton(text="📊 Statistika"), KeyboardButton(text="📥 Excel hisoboti")],
            [KeyboardButton(text="📲 Ulanish QR kodi"), KeyboardButton(text="👥 Sheriklar (Adminlar)")],
            [KeyboardButton(text="⚙️ Daftar nomi"), KeyboardButton(text="🛡 Xavfsizlik va Tiklash")],
            [KeyboardButton(text=f"⏳ Obuna: {days_left} kun qoldi"), KeyboardButton(text="📲 Ekranga znachok")],
        ]
